export default function Home() {
  return (
    ...
    <div className="border border-4 border-double border-primary-100   w-72 h-96 bg-secondary-100 ">
<div className="flex justify-center ">
      <div> 
        <img src="./img/PalavraViva.jpeg" alt="Logo Teatro" width={100} height={100} />
      </div>
      <div> 
        <img src="./img/Dunamai.jpeg" alt="Logo Teatro" width={100} height={100} />
      </div>
      <div> 
        <img src="./img/LogoJpac.jpeg" alt="Logo Teatro" width={100} height={100} />
      </div>
</div>
        <div>
          <div className=" flex align-center justify-center text-xl p-8">
          ...
          <div className=" flex justify-center p-3 gap-12 ">
              <div>
                  ...
                  <div className="flex justify-center items-center cursor-pointer">
                      <a href="">
                        <div className="flex justify-center items-center text-animation-100 hover:text-primary-200 cursor-pointer">
              ...
              <a href="https://www.youtube.com/@ccpeoficial3617/streams">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="text-animation-100 hover:text-primary-200"><path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17"/><path d="m10 15 5-3-5-3z"/></svg>
                  </div>
              </a>
              <a href="https://www.facebook.com/comu.ccpe.3">
                  <div>
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="text-animation-100 hover:text-primary-200"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                  </div>
              </a>
